...
import ru.sitronics.velobike.data.repositories.history.HistoryRepositoryImp
...
abstract class RepositoryModule {
    ...
    @Singleton
    @Binds
    abstract fun bindHistoryRepository(repositoryImpl: HistoryRepositoryImp): HistoryRepository
}